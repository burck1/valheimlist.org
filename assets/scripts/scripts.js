...
function showCommentsInput() {
    ...
    if (localStorage.getItem("session")) {
        ...
        fetch(serverAddress + '/reviewget', {
            ...
            if (response.status === 200) {
                e("leave-review").innerHTML = `<p>You have reviewed this server. It can take 5 minutes to appear.<br><span style="font-size: 10px;color: #a86b6b;cursor:pointer;" onclick="sendReview(true)">Delete review?</span></tov></p>`
            } else {
